...
import Billboard from "@/components/store/carousel/carousel";
...
const StorePage = async () => {
  const products = [
    {
      ...
      images: [
        ...
        },
        {
          id: "img006",
          imageUrl:
            "https://sieuthixanh.com.vn/Upload/products/zoom/Snack-khoai-tay-vi-than-bo-nuong-Texas-Lays-Wavy-goi-65g132693557547210024.jpg",
        },
      ],
    },
    {
  ...
  const billboard = {
    id: "string",
    label: "Hello To My Shop",
    imageUrl:
      "https://media.coolmate.me/cdn-cgi/image/width=1920,quality=80,format=auto/uploads/January2024/Banner-Basicdesk.png",
  };
    ...
    <>
      <div className="space-y-10 pb-10">
        ...
        <div className="flex flex-col gap-y-8 px-4 sm:px-6 lg:px-8">
          <ProductList title="Sản Phẩm Đang Hot" items={products} />

          <ProductList title="Sản Phẩm Bán Chạy" items={products} />
        </div>
      </div>
    </>
  );
